...
class SegmentTree:
    ...
    def lower_bound(self, x, idx=1):
        """Finds min index j such that a[j] >= x; -1 - if not found; j is 0-based"""
        while idx < self._size:
            ...
            if left_max >= x:
                ...
                idx = 2 * idx + 1
        return idx - self._size if self.data[idx] >= x else -1
